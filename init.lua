    ...
    config = function()
      ...
      vim.api.nvim_create_autocmd('LspAttach', {
        ...
        callback = function(event)
          ...
          map('gr', function()
            require('telescope.builtin').lsp_references { fname_width = 0.60 }
          end, '[G]oto [R]eferences')

          -- Jump to the implementation of the word under your cursor.
          --  Useful when your language has ways of declaring types without an actual implementation.
          map('gI', function()
            require('telescope.builtin').lsp_implementations { fname_width = 0.60 }
          ...
          map('<leader>ds', function()
            require('telescope.builtin').lsp_document_symbols { symbol_width = 0.90, symbol_type_width = 0.10 }
